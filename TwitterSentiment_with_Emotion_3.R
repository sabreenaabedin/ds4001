...
key='oo4MPtBAoOapvyNMBvKBrLLZu'
secret='ca2Yuda4QLUEMfxl2vnrltozZVvKLPVOWsaei3hSzP00tEwKZA' 

setwd("C:/Users/Sabreena/Dropbox/DS/text_mining")

access_token='505067904-UXkeyBfUTbj7mD6zwxFPGbN6fZEGNuobbKu4ZNMr' 
access_token_secret='RYVu0JkTuOuqmEmvbkBHqrKbIAmYMyVdLJEOqjd6MYWgd'

download.file(url="http://curl.haxx.se/ca/cacert.pem",
              destfile="C:/Users/Sabreena/Dropbox/DS/text_mining/cacert.pem",
              method="curl")
...
# harvest some tweets
some_tweets = searchTwitter("UVA", n=2000, lang="en", retryOnRateLimit=120)
...
classify_emotion <- function(textColumns,algorithm="bayes",prior=1.0,verbose=FALSE,...) {
  ...
  lexicon <- read.csv("C:/Users/Sabreena/Dropbox/DS/text_mining/emotions.csv.gz",header=FALSE)
  ##lexicon <- read.csv(system.file("C:/Users/Sabreena/Dropbox/DS/text_mining/emotions.csv.gz",package="sentiment"),header=FALSE)
...
classify_polarity <- function(textColumns,algorithm="bayes",pstrong=0.5,pweak=1.0,prior=1.0,verbose=FALSE,...) {
  matrix <- create_matrix(textColumns,...)
  lexicon <- read.csv("C:/Users/Sabreena/Dropbox/DS/text_mining/subjectivity.csv.gz",header=FALSE)
