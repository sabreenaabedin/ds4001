...
##### R data structures --------------------
#### Let's create our own data.  Imagine you were collecting data about patients with the flu and had to manually enter the data.
## Vectors -----

# create vectors of data for three medical patients
subject_name <- c("John Doe", "Jane Doe", "Steve Graves") ##The  quotes indicate that these values are strings##
temperature <- c(98.1, 98.6, 101.4)
flu_status <- c(FALSE, FALSE, TRUE) ## These are Boolean values

# Let's access the second element in body temperature vector
temperature[2]
...
##### Exploring and understanding data (how to load exisiting data and work with it)-------

## data exploration example using used car data
usedcars <- read.csv("~/Desktop/DS 4559 2016/usedcars.csv", stringsAsFactors = FALSE)
...
# whatabout summarizing non-numeric features?
summary(usedcars)
...
----------------------------------------------------------------------
## Now we need to install a special package to allow us to visualize the data:
...
# Now you create a histogram for mileage with the proper label  and units
hist(usedcars$mileage, main = "Histogram of Mileage", xlab = "Mileage")
...
## Why do we want to round the data?
